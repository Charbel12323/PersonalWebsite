...
export function EducationSection() {
  ...
  return (
    <section ref={sectionRef} id="education" className="py-16 px-6 bg-[#0a1628] text-white">
        ...
        <div className={`bg-[#0f2744]/50 rounded-2xl p-8 border border-blue-900/20 transition-all duration-700 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-400 text-sm font-sans mb-4">September 2023 – April 2027 (Expected)</p>

              <div className="flex flex-wrap gap-2">
                <div className="px-4 py-1.5 bg-slate-900/40 border border-[#b8860b]/20 rounded-lg">
                  <p className="text-[#b8860b] text-xs font-sans">GPA: 3.8/4.0</p>
                </div>
                <div className="px-4 py-1.5 bg-slate-900/40 border border-[#b8860b]/20 rounded-lg">
                  <p className="text-[#b8860b] text-xs font-sans">Dean&apos;s List</p>
                </div>
                <div className="px-4 py-1.5 bg-slate-900/40 border border-[#b8860b]/20 rounded-lg">
                  <p className="text-[#b8860b] text-xs font-sans">AWS Data Engineer</p>
                </div>
                <div className="px-4 py-1.5 bg-slate-900/40 border border-[#b8860b]/20 rounded-lg">
                  <p className="text-[#b8860b] text-xs font-sans">AWS Cloud Practitioner</p>
                </div>
              </div>
            </div>
          </div>
